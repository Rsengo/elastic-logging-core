...
import { LogLevel, LogMessageData } from '../logger/models';
import { ElasticMessageData, ElasticIndex, DeprecatedElasticIndex, ElasticMessageMetadata } from './models';
...
class LogMessageFactory {
    ...
    public createLogMessage (data: LogMessageData, level: LogLevel) {
